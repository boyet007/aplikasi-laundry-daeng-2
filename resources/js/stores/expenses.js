...
const actions = {
    ...
    getExpenses({ commit, state }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(`/expenses?page=${state.page}&q=${search}`)
                .then(response => {
    ...
    editExpenses({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/expenses/${payload}/edit`).then(response => {
                resolve(response.data);
            });
        });
    },
    ...
    updateExpenses({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.put(`/expenses/${payload.id}`, payload).then(response => {
                resolve(response.data);
            });
        });
    },
    acceptExpenses({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.post(`/expenses/accept`, { id: payload }).then(response => {
                resolve(response.data);
            });
        });
    },
    cancelExpenses({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.post(`/expenses/cancel`, payload).then(response => {
                resolve(response.data);
            });
        });
    },
    removeExpenses({ dispatch }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.delete(`/expenses/${payload}`).then(response => {
                //AMBIL DATA TERBARU
