...
const actions = {
    ...
    getProducts({ commit, state }, payload) {
        ...
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(`/product?page=${state.page}&q=${search}`)
                .then(response => {
    ...
    addLaundryType({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .post(`/product/laundry-type`, payload)
                .then(response => {
                    resolve(response.data);
                })
                .catch(error => {
    ...
    editProduct({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/product/${payload}/edit`).then(response => {
                resolve(response.data);
            });
        });
    },
    ...
    removeProduct({ dispatch }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.delete(`/product/${payload}`).then(response => {
